globalThis.CONSTANTS = {
  ...
  CURRENT_SYSTEM: ['hashrate', 'car', 'project', 'user', 'origin'],
  MAP_AK: '777W5OPtOvfQCtNaRwvcJZ2tXoFJ1h4Y',
  MAP_STYLE_ID: 'b28706738ee88f2cf1bd8d31c4d1be74',
  BASE_URL: process.env.NODE_ENV === 'development' ? 'http://localhost:4000' : 'http://122.51.216.157:4000',
  STATIC_URL: process.env.NODE_ENV === 'development' ? 'http://localhost:4000' : 'http://122.51.216.157：4000',
  LOGO_TITLE: '越泰科技',
  SYSTEM_NAME: '越泰低空无人机与算力管理系统',
